...
try
{
    ...
    # get details about defined apps
    foreach ($Id in $Ids)
    {
        ...
        {
            Write-Logging -Value "[SR] Specified application: '$($WinGetAppInfo.Name)' with version: '$($WinGetAppInfo.Version)' is already installed" -StdOut 'None'
        ...
        # clean-up
        Get-Variable -Name 'WinGetAppInfo' -ErrorAction 'SilentlyContinue' | Remove-Variable -Force
    }
